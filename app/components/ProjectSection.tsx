...
const projects = [
    {
        ...
        icons: [<FaReact key="1" className="text-blue-500 text-3xl" />, <FaHtml5 key="2" className="text-orange-500 text-3xl" />, <FaGithub key="3" className="text-3xl" /> ]
    },
    {
        id: 2,
        title: "Projet Node.js",
        description: "API développée avec Node.js",
        icons: [<FaNodeJs key="1" className="text-green-500 text-3xl" />, <FaCss3 key="2" className="text-blue-500 text-3xl" />]
    },
    {
        id: 3,
        title: "Projet Base de données",
        description: "Gestion de base de données",
        icons: [<FaDatabase key="1" className="text-gray-500 text-3xl" />, <FaHtml5 key="2" className="text-orange-500 text-3xl" />]
    },
    {
        id: 4,
        title: "Projet React Native",
        description: "Application mobile avec React Native",
        icons: [<FaReact key="1" className="text-blue-500 text-3xl" />, <FaCss3 key="2" className="text-blue-500 text-3xl" />]
    },
    {
        id: 5,
        title: "Projet API",
        description: "Backend en Node.js",
        icons: [<FaNodeJs key="1" className="text-green-500 text-3xl" />, <FaHtml5 key="2" className="text-orange-500 text-3xl" />]
    },
    {
        id: 6,
        title: "Projet Gestion de données",
        description: "Système de gestion de données",
        icons: [<FaDatabase key="1" className="text-gray-500 text-3xl" />, <FaCss3 key="2" className="text-blue-500 text-3xl" />]
    }
];
    ...
    return (
        <section className="min-h-screen w-full content-center py-8">
            <div className="container mx-auto flex flex-col md:flex-row">
                <div className="md:w-1/4 w-full flex items-center justify-center md:justify-start mb-8 md:mb-0">
...
const about = {
    ...
    info: [
        ...
        {fieldName: "Location", fieldValue: "New York, USA"},
        {fieldName: "Email", fieldValue: "john.doe@example.com"},
...
const Sidebar = ({setSection}) => {
    return (
        ...
        <div className="md:w-1/4 w-full flex-col items-start space-y-4 content-center">
            ...
            <p className="mt-3">Développeur web avec 3 ans d’expérience et étudiant à Epitech Lille, je suis passionné par les
            ...
            <div className="w-full flex flex-col space-y-4">
                <button
                    className="text-xl font-bold bg-zinc-900 text-white px-5 py-3 rounded-lg hover:text-soft-orange transition-colors duration-300"
                    onClick={() => setSection('about')}>
                    A propos de moi
                </button>
                <button className="text-xl font-bold bg-zinc-900 px-5 py-3 rounded-lg hover:text-soft-orange transition-colors duration-300"
        ...
        {skills.skillList.map((skill, index) => {
            return (
                <li key={index} className="justify-center flex relative group">
                    <div
                        className="flex items-center justify-center h-32 w-32 p-4 bg-zinc-900 rounded-lg text-6xl text-white-500 group-hover:text-soft-orange transition-opacity duration-300">
                        {skill.icon}
                    </div>
                    <span
